...
Editorial reading layout. Cards on the home page. Tagline: “I'm just trying to keep up.” Home heading: “Mutterings and soft cursings on AI”. Nav, breadcrumbs, and index label: “Blog entries”. Byline “By Brenden Portolese” links to https://www.linkedin.com/in/brendenportolese/ on the home page, idea pages, and footer. Light and dark themes, following the system preference until the visitor toggles. The choice is stored in `localStorage`.
